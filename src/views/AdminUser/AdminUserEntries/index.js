...
import AdminUserCycle from './AdminUserCycle';
  ...
  render() {
    return (
      <div className='admin-user-entries'>
        <div className='admin-user-entries-title'>{this.props.tile && this.props.tile.userTileName}</div>
        ...
        { this.state.showEditForm ?
          ...
          <div className='admin-user-entries-list'>
           {this.renderCycles()}
          </div>
        </div>
      </div>
